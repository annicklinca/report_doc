...
const PrintPage = () => {
  ...
  const generateData = () => {
    ...
    let config = {
      ...
      url: 'https://gis.police.gov.rw/server/rest/services/Country_Crimes_Data/FeatureServer/0/query?where=1%3D1&objectIds=&time=&geometry=&geometryType=esriGeometryEnvelope&inSR=&defaultSR=&spatialRel=esriSpatialRelIntersects&distance=&units=esriSRUnit_Foot&relationParam=&outFields=*&returnGeometry=true&maxAllowableOffset=&geometryPrecision=&outSR=&havingClause=&gdbVersion=&historicMoment=&returnDistinctValues=false&returnIdsOnly=false&returnCountOnly=false&returnExtentOnly=false&orderByFields=&groupByFieldsForStatistics=crime_type_l3%2Cprovince&outStatistics=%5B%7B%0D%0A++%22statisticType%22%3A+%22Count%22%2C%0D%0A++%22onStatisticField%22%3A+%22crime_type_l3%22%2C%0D%0A++%22outStatisticFieldName%22%3A+%22total%22%0D%0A%7D%5D&returnZ=false&returnM=false&multipatchOption=xyFootprint&resultOffset=&resultRecordCount=&returnTrueCurves=false&returnExceededLimitFeatures=false&quantizationParameters=&returnCentroid=false&timeReferenceUnknownClient=false&maxRecordCountFactor=&sqlFormat=none&resultType=&featureEncoding=esriDefault&datumTransformation=&f=json&token=utDHs4ZvWLgV57HUr_MfTlGDyCtceIeaVtk9DCXQrFA9j6p7p_bTOxpf-_B4_hba9PO3I6bmB1XrrBDjuOHnU962lZQuBFAZS93U9uS-gUAuVx3MhYYyPa9F-f6YP9Hm0RDL7OfJPYhh6ErV1VXkoKYLG5QmQuVxsFPBNClY7Vg.',
      headers: {
        'Cookie': 'AGS_ROLES="Jk5StakH+Y4WR7g7mPn4eKb8sWhU3d9k90G0n7a60Ybj2z1YLqHoFZFctv7b+T07yj2nkGtwUg5Rmz1Q0wncqOAiqwo5WB656FYO8MBC3vQpuPfJXA5vF9CC+SHu6IqEB2SJOnxAcX0sbUROaYfp30DEEHoaep0//MnmWRdeVzQ="'
      }
    };
